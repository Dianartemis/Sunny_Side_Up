(function($) {
  ...
  var settings = document.getElementById('gridSettingPics');
  ...
  var getEndGameMessage = function(score) {
    var message = "";
    if (score == 100) {
      message = "You have a killer memory! Dementia who?"
    }
    else if (score >= 70 ) {
      message = "Good but not great. Try again!"
    }
    else if (score >= 50) {
      message = "Not bad but you can get that score up "
    }
    else {
